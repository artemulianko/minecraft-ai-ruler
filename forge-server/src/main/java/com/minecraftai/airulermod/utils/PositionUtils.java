...
public class PositionUtils {
    ...
    /**
     * Finds the nearest empty position to the given position within the game world.
     * An empty position is determined based on certain criteria defined in the isPositionSafe method.
     * Uses a breadth-first search to locate the closest suitable position.
     *
     * @param level The game world level where the search is performed
     * @param pos   The initial position from which the search begins
     * @return The nearest empty position as a BlockPos object, or null if no suitable position is found
     */
    public static @Nullable BlockPos findNearestEmptyPosition(Level level, Vec3i pos) {
